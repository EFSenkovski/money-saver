...
public record MovimentoResp(Long id, String descricao, Double valor, TipoMovimento tipoMovimento,
                            ContaForMovimentoResp conta,
                            LocalDate dataEfetivacao, LocalDateTime criadoEm, Set<String> tags,
